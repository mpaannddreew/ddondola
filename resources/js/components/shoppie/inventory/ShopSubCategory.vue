        ...
        <template v-if="saving">
            <td colspan="5">
                <div align="center">
                    ...
                    <p class="m-0">Saving subcategory changes...</p>
                </div>
            </td>
        </template>
        <template v-else>
        ...
        methods: {
            ...
            saveChanges() {
                ...
                axios.post(graphql.api, {
                    query: graphql.editSubCategory,
                    variables: {categoryId: this.category.id, subcategory: {name: this.name, description: this.description}}
