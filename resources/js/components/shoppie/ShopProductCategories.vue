                        ...
                        <ul class="list-group">
                            <li class="list-group-item px-4" v-for="(subCategory, _indx) in category.categories" :key="_indx">
                                <div class="custom-control custom-checkbox mb-1">
                                    <input type="checkbox" class="custom-control-input" :name="'category-' + category.id + '-' + indx" :id="'category-' + category.id + '-' + indx" v-model="subCategoryIds" :value="subCategory.id">
                                    <label class="custom-control-label" :for="'category-' + category.id + '-' + indx">{{ subCategory.name }} ({{ subCategory.productCount }})</label>
                                </div>
                            </li>
                        </ul>
                    </div>
