        ...
        <div class="activity">
            <div class="activity-box">
                <ul class="activity-list">
                    ...
                    <li>
                        <div class="activity-user">
                            <a href="profile.html" class="avatar" title="" data-toggle="tooltip" data-original-title="Jeffery Lalor">L</a>
                        </div>
                        <div class="activity-content">
                            <div class="timeline-content">
                    ...
                    <li>
                        <div class="activity-user">
                            <a href="profile.html" title="" data-toggle="tooltip" class="avatar" data-original-title="Catherine Manseau">
                                <img alt="Catherine Manseau" src="/images/avatars/0.jpg" class="img-fluid rounded-circle">
                            </a>
                        </div>
                        <div class="activity-content">
                            <div class="timeline-content">
                    ...
                    <li>
                        <div class="activity-user">
                            <a href="#" title="" data-toggle="tooltip" class="avatar" data-original-title="Bernardo Galaviz">
                                <img alt="Bernardo Galaviz" src="/images/avatars/0.jpg" class="img-fluid rounded-circle">
                            </a>
                        </div>
                        <div class="activity-content">
                            <div class="timeline-content">
                    ...
                    <li>
                        <div class="activity-user">
                            <a href="profile.html" title="" data-toggle="tooltip" class="avatar" data-original-title="Mike Litorus">
                                <img alt="Mike Litorus" src="/images/avatars/0.jpg" class="img-fluid rounded-circle">
                            </a>
                        </div>
                        <div class="activity-content">
                            <div class="timeline-content">
                    ...
                    <li>
                        <div class="activity-user">
                            <a href="profile.html" title="" data-toggle="tooltip" class="avatar" data-original-title="Jeffery Lalor">
                                <img alt="Jeffery Lalor" src="/images/avatars/0.jpg" class="img-fluid rounded-circle">
                            </a>
                        </div>
                        <div class="activity-content">
                            <div class="timeline-content">
