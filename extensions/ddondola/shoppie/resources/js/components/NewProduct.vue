    ...
    <div>
        <div class="card card-small border" v-if="!loaded || (loaded && !requirementsLoaded)">
            <div class="card-body">
                ...
                <div align="center" v-if="!requirementsLoaded && loaded">
                    <h4 class="m-0"><i class="material-icons">error</i></h4>
                    <p class="mb-3">You have not added any {{ infoText }} yet!</p>
                    <a :href="inventoryUrl + '/' + addUrl" class="btn btn-success btn-pill"><i class="fa fa-plus"></i> Add {{ infoTextUpper }}</a>
                </div>
            </div>
        </div>
