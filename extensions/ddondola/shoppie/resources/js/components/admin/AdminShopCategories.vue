        ...
        <div>
            ...
            <div class="card card-small lo-stats h-100 border border-top-radius-0">
                <table class="table mb-0">
                    ...
                    <tr>
                        <th>Name</th>
                        <th class="lo-stats__items text-center">Shops</th>
                        <th>Description</th>
                        <th></th>
                    </tr>
                    </thead>
...
<script>
    import ShopCategory from "./AdminShopCategory";
    export default {
        ...
        methods: {
            ...
            loadData(response) {
                ...
                this.paginatorInfo = response.data.data.categories.paginatorInfo;
            },
            validate() {
            ...
            createCategory() {
                this.loading = true;
                axios.post(graphql.api, {
                    query: graphql.createShopCategory,
                    variables: {
                        category: {
                            name: this.name,
