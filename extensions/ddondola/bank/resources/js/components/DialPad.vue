<template>
    <div class="card card-small h-100 border-top border-left border-right">
...
<script>
    export default {
        ...
        methods: {
            ...
            initiate() {
                if (this.canInitiate)
                    this.paymentModal = this.openPaymentModal(this.amount, 'me@ddondola.com', 'UGX', 'mobilemoneyuganda,card', this.meta, this.raveCallback);
            },
            typeNumber(number) {
                this.amount += `${number}`;
            },
